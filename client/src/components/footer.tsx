    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-semibold">Career Pathfinder AI</span>
            </div>
            <p className="mt-2 text-sm text-gray-400">Discover your ideal career path with AI-powered guidance.</p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <div>
              <h3 className="text-sm font-semibold text-gray-300 tracking-wider uppercase">Resources</h3>
              <ul className="mt-4 space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">Career Blog</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Skill Development</a></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-gray-400">© 2025 Career Pathfinder AI. All rights reserved.</p>
